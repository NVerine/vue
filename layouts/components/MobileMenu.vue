  ...
  <li class="nav-item dropdown main-menu d-block d-sm-none">
    ...
    <div class="dropdown-menu dropdown-menu-right hiding">
      ...
      <form class="accordion">
        <div v-for="(item, i) in itensLoaded" :key="i" class="menu-body">
          ...
          <div v-if="item.children">
            ...
            <div class="collapse" :id="'menu-mobile'+i">
              <ul class="nav menu-list">
                <li v-for="(c, index) in item.children" :key="index" class="nav-item menu-list-item col-12 p-0">
...
<script>
import MenuMixin from "~/mixed/MenuMixin";
export default {
  name: "mobile-menu",
  mixins: [MenuMixin],
  watch:{
    ...
    // },
    // "localStorage.permissoes": function (e) {
    //   console.log(e);
    //   this.montaMenu();
    // },
  },
