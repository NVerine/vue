<template>
  <div v-if="tipo !== 'hidden' && !isTable" :class="['mt-3', 'col-md-'+tamanho]">
    <div class="control">
  ...
  <div v-else-if="isTable" class="bmd-form-group" :class="getClasse">
    <input :id="'campo_'+getNome()" :required="requerido" :readonly="leitura"
           :type="tipo || 'text'" class="form-control" v-model="value"
           :name="getNome()" :class="inputClasse" @keydown="lockSize"
    >
...
export default {
  ...
  props : {tamanho: {}, nome: {}, descricao: {}, modelo: {}, tipo: {}, requerido: {},
    funcao: {}, prefixo: {}, index: {}, comprimento: {}, leitura: {}, inputClasse: {}, isTable: {type: Boolean, default: false}},
  data() {
    return{
