  ...
  <div class="row">
    <div class="card mb-1">
      <div class="card-header row card-header card-header-info ">
        <div class="col-md-4">
          <h4 class="card-title"><i class="mr-2 fa fa-user"></i>Test</h4>
        </div>
          ...
          <div class="nav-tabs-navigation float-right">
            <div class="nav-tabs-wrapper">
              <ul class="nav nav-tabs mt-0" role="tablist">
                ...
                <tab-link icon="fa fa-plus" txt="Inserir" :rota="{name: 'test_edita', params : { id : 0}}"></tab-link>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane active" id="sd1">
          <div class="card-body">
            <div class="mt-4 row">
              ...
              <tabela nome="test" target="test_edita" :itens="itens"></tabela>
              <div class="col-md-12">
