...
(function (global, factory) {
  ...
  /* globals Popper */
  Popper$1.Defaults.modifiers.computeStyle.gpuAcceleration = false;
  /**
   ...
   *
   * You can import other modules here, including js packages. When bundling using rollup you can mark those modules as js and have them excluded or, if they have a jsnext:main entry in their package.json (like this package does), let rollup bundle them into your dist file.
   *
